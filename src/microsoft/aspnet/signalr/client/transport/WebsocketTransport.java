...
public class WebsocketTransport extends HttpClientTransport {
	...
	private int connectionTimeout = 5 * 1000; // five seconds
	...
	public SignalRFuture<Void> start(ConnectionBase connection, ConnectionType connectionType,
		...
		mWebSocketClient = new WebSocketClient(uri, new Draft_17(), connection.getHeaders(), connectionTimeout) {
			@Override
		...
		log("Connecting to " + uri, LogLevel.Verbose);
		mWebSocketClient.connect();

		/*
		 * FIXME: Replace the 'closed' handler with list of handlers, otherwise
